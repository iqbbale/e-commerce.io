  ...
  <div style={{ minHeight:'100vh', display:'flex', background:'var(--color-bg)' }}>
    ...
    >
      ...
      <div style={{
        ...
        backgroundImage:'linear-gradient(rgba(249,115,22,.6) 1px, transparent 1px), linear-gradient(90deg, rgba(249,115,22,.6) 1px, transparent 1px)',
      ...
      <div style={{
        ...
        alignItems:'center', justifyContent:'center', height:'100%', padding:'3rem 3.5rem', textAlign:'center',
      }}>
        {/* Logo */}
        <Link to="/" style={{ display:'flex', alignItems:'center', gap:12, marginBottom:56, textDecoration:'none' }}>
          ...
          <span style={{ fontFamily:'Syne,sans-serif', fontSize:'1.75rem', fontWeight:800, color:'#fff' }}>
            NovaMart
          </span>
        </Link>

        <h2 style={{
          fontFamily:'Syne,sans-serif', fontSize:'2rem', fontWeight:800, color:'#fff',
        ...
        <p style={{ color:'#94a3b8', fontSize:'1rem', lineHeight:1.7, marginBottom:40, maxWidth:340 }}>
          Temukan ribuan produk pilihan dengan kualitas terbaik. Pengiriman cepat,
          harga terjangkau, dan layanan terpercaya.
        </p>
        ...
        <div style={{ display:'grid', gridTemplateColumns:'repeat(3,1fr)', gap:12, width:'100%' }}>
          {STATS.map(s => (
            <div key={s.label} style={{
              ...
              <p style={{ fontFamily:'Syne,sans-serif', fontSize:'1.5rem', fontWeight:800, color:'#fb923c' }}>
                {s.value}
              </p>
    ...
    <div style={{
      ...
      <div style={{ width:'100%', maxWidth:440 }}>
        ...
        >
          ...
          <span style={{ fontFamily:'Syne,sans-serif', fontSize:'1.35rem', fontWeight:800 }}>NovaMart</span>
        </Link>
