        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed mb-6">
              Platform belanja online terpercaya dengan ribuan produk pilihan. Kualitas terjamin, harga terbaik.
            </p>
          ...
          {/* Links */}
          <div>
            <h4 className="text-white font-semibold mb-4" style={{ fontFamily: 'Syne, sans-serif' }}>Belanja</h4>
          ...
          {/* Bantuan */}
          <div>
            <h4 className="text-white font-semibold mb-4" style={{ fontFamily: 'Syne, sans-serif' }}>Bantuan</h4>
            <ul className="space-y-2.5">
              {[
          ...
          {/* Contact */}
          <div>
            <h4 className="text-white font-semibold mb-4" style={{ fontFamily: 'Syne, sans-serif' }}>Kontak</h4>
            <ul className="space-y-3">
              {[
                ...
                <li key={text} className="flex items-start gap-3">
                  <Icon size={15} className="mt-0.5 flex-shrink-0" style={{ color: '#f97316' }} />
        ...
        <div className="container-custom flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-4">
            {['Privasi', 'Syarat & Ketentuan', 'Keamanan'].map((item) => (
              <a key={item} href="#" className="text-xs hover:text-orange-400 transition-colors">
                {item}
              </a>
            ))}
          </div>
